...
const LOCAL_FUNCTIONS = {
  ...
  /* ────────── CITAS ────────── */
  /**
   * Crea una cita para el profesional indicado o el de la sesión.
   *  - Requiere: titulo, fecha_hora_inicio, fecha_hora_fin
   *  - Opcional: descripcion, persona, id_paciente, estado,
   *              ubicacion, notificacion, id_profesional, id_servicio
   */
  async add_cita(args = {}, req) {
    ...
    if (overlap[0].n)
      throw new Error('El profesional ya tiene otra cita en ese horario');
  ...
  /**
   * Busca citas filtrando por profesional, paciente o rango de fechas.
   *  - Args opcionales: id_profesional, id_paciente, estado,
   *    id_servicio, startDate, endDate, all
   *  - Devuelve array de citas.
   */
